...
class test_prm_v2(PRM):
    def __init__(
        ...
        self.bad_token = '-'
        self.step_tag = 'ки'
        self.model_id = "mtzig/v1_mistral_lora"#only to load tokenizer
        ...
        if self.quantization_config:
            ...
            checkpoint_path = "/home/ec2-user/strawberry_checkpoints/v2_1118_checkpoint0"

            peft_config = PeftConfig.from_pretrained(checkpoint_path)

            base_model = AutoModelForCausalLM.from_pretrained(peft_config.base_model_name_or_path)

            self.model = PeftModel.from_pretrained(base_model, checkpoint_path, is_local=True)
